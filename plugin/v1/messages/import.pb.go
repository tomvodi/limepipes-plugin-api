...
func (x *ImportFileRequest) GetFilePath() string {
	if x, ok := x.GetImportFile().(*ImportFileRequest_FilePath); ok {
		return x.FilePath
	}
	return ""
}
...
func (x *ImportFileRequest) GetFileData() []byte {
	if x, ok := x.GetImportFile().(*ImportFileRequest_FileData); ok {
		return x.FileData
	}
	return nil
}

type isImportFileRequest_ImportFile interface {
	isImportFileRequest_ImportFile()
}
...
func (*ImportFileRequest_FilePath) isImportFileRequest_ImportFile() {}

func (*ImportFileRequest_FileData) isImportFileRequest_ImportFile() {}
...
var file_plugin_v1_messages_import_proto_rawDesc = []byte{
	...
	0x46, 0x69, 0x6c, 0x65, 0x44, 0x61, 0x74, 0x61, 0x22, 0x60, 0x0a, 0x11, 0x49, 0x6d, 0x70, 0x6f,
	0x72, 0x74, 0x46, 0x69, 0x6c, 0x65, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x1d, 0x0a,
	0x09, 0x66, 0x69, 0x6c, 0x65, 0x5f, 0x70, 0x61, 0x74, 0x68, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09,
	0x48, 0x00, 0x52, 0x08, 0x66, 0x69, 0x6c, 0x65, 0x50, 0x61, 0x74, 0x68, 0x12, 0x1d, 0x0a, 0x09,
	0x66, 0x69, 0x6c, 0x65, 0x5f, 0x64, 0x61, 0x74, 0x61, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0c, 0x48,
	0x00, 0x52, 0x08, 0x66, 0x69, 0x6c, 0x65, 0x44, 0x61, 0x74, 0x61, 0x42, 0x0d, 0x0a, 0x0b, 0x69,
	0x6d, 0x70, 0x6f, 0x72, 0x74, 0x5f, 0x66, 0x69, 0x6c, 0x65, 0x22, 0x5d, 0x0a, 0x12, 0x49, 0x6d,
...
func file_plugin_v1_messages_import_proto_init() {
	...
	file_plugin_v1_messages_import_proto_msgTypes[1].OneofWrappers = []any{
		(*ImportFileRequest_FilePath)(nil),
		(*ImportFileRequest_FileData)(nil),
	}
	type x struct{}
